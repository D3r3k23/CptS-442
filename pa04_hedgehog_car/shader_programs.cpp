...
//
{
    ...
    //
    ifstream vertex_shader_file("constant_color_vertex_shader.glsl");
    stringstream vertex_shader_text;
    vertex_shader_text << vertex_shader_file.rdbuf();
    compileVertexShader(vertex_shader_text.str());

    ifstream fragment_shader_file("passthru_fragment_shader.glsl");
    stringstream fragment_shader_text;
    fragment_shader_text << fragment_shader_file.rdbuf();
    compileFragmentShader(fragment_shader_text.str());
}
